        ...
        {slides.map((slide, index) => (
          <div key={slide.id} className="relative aspect-[3/4] bg-visu-gray rounded-lg overflow-hidden border border-white/10 group">
            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-between z-20 pointer-events-none">
              ...
              {!isBaked && (
                 <div className="absolute inset-0 bg-gradient-to-t -z-10 from-black/95 via-black/20 to-black/40"></div>
              )}
              ...
              <div className="w-full">
                ...
                <div className="w-full h-1 bg-white/20 mb-4 rounded-full overflow-hidden">
                   <div 
                     ...
                     style={{ width: `${(slide.id / 6) * 100}%`, backgroundColor: brandColor }}
                   ></div>
                </div>
              ...
              <div className="mt-auto mb-4">
                ...
                */}
                ...
                {!isBaked && (
                  <>
                    <h3 
                      className="text-4xl md:text-5xl uppercase leading-[0.85] mb-4 drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)]"
                    ...
                    <p 
                      className="text-sm opacity-90 leading-tight max-w-[95%] drop-shadow-md"
